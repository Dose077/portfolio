    ...
    <div>
        ...
        >
         <div className="overlay   items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500  rounded-t-xl ">
          ...
          <CodeBracketIcon className='w-10 h-10 text-[#ADB7BE]  absolute top-1 left-1/2 transform -translate-x-1/2 -transalte-y-1/2 cursor-pointer group-hover/link:text-white'/>
          </Link>
          <Link  href={previewUrl} className='h-14 w-14 border-2 relative rounded-full  border-[#ADB7BE] hover:border-white group/link'>
            
            <EyeIcon className='w-10 h-10 text-[#ADB7BE]  absolute top-1 left-1/2 transform -translate-x-1/2 -transalte-y-1/2 cursor-pointer group-hover/link:text-white'/>
            </Link>
        </div>
        </div>

        <div className='text-white rounded-b-xl border border-blue-500 mt-2 bg-[#181818] py-6 px-4'>
